...
begin
  try //Старт вывода
    ...
    ExProcess.Parameters.Add('[[ -f ~/.config/ss_obfs_gui/ss_obfs_gui.log ]] || touch ' +
      '~/.config/ss_obfs_gui/ss_obfs_gui.log && tail -n 100 -f ~/.config/ss_obfs_gui/ss_obfs_gui.log 2> >(grep -v truncated >&2)');
